...
class N2OEmissionsCalculator:
    ...
    def calculate_for(self, crop: FarmedCrop):
        ...
        instance.calculate_total(crop.activities.fertilizing, crop.field.land.soil)
    ...
    def _get_conversions(self, crop):
        ...
        # ToDo: Probably the right way would be to add metadata to these values
        #  and use pandas to create a dataframes
